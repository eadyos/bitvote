...
grails.urlmapping.cache.maxsize = 100
...
environments {
    development {
        ...
        enableMail=false
        grails.plugins.stripe.secretKey='REDACTED'
        grails.plugins.stripe.publishableKey='REDACTED'
    ...
    production {
        ...
        grails.serverURL = "https://robsrules.com"
        grails.plugins.stripe.secretKey='REDACTED'
        grails.plugins.stripe.publishableKey='REDACTED'

        baseRedirectUrl = 'https://robsrules.com'
    }
}
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'org.eady.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'org.eady.UserRole'
grails.plugin.springsecurity.authority.className = 'org.eady.Role'
